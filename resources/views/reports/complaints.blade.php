...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Daily Call Entry List - Complaints </h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 offset-4">
                                <form id="date-range" action="{{ route('admin.report.complaints') }}">
                                    @csrf
                        ...
                        <div class="table-responsive">
                            <table id="datatable-FaqCategory" class="table table-bordered table-striped table-hover datatable datatable-FaqCategory">
                                ...
                                <tbody>
                                    @foreach($complaints as $key => $entry)
                                    <tr data-entry-id="{{ $entry->id }}">
                                        ...
                                        <td>
                                            {{ $entry->complaint_ticket ?? '' }}
                                        </td>
                                        <td>
                                            {{ $entry->complaint_comments ?? '' }}
                                        </td>
                                        <td>
                                            {{ $entry->user_id ?? '' }}
                                        </td>
