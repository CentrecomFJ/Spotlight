        ...
        @foreach($category->articles as $article)
            <div class="panel panel-transparent">
                <div class="article-heading-abb">
                    <a href="{{ route('kb.articles.show', [$article->slug, $article->id]) }}">
                        <i class="fa fa-link fa-rotate-90"></i> {{ $article->title }} </a>
                </div>
                ...
                <div class="article-read-more">
                    <a href="{{ route('kb.articles.show', [$article->slug, $article->id]) }}" class="btn btn-default btn-wide">Read more...</a>
                </div>
            </div>
        @endforeach
