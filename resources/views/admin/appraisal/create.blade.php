                        ...
                        <form action="{{ route("admin.appraisal.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->has('review_type_id') ? 'has-error' : '' }}">
                                ...
                                <select name="review_type_id" id="review_type_id" class="form-control select2">
                                    @foreach($review_types as $id => $review_type)
                                    <option value="{{ $id }}" {{ (old('review_type_id', 0) == $id || isset($appraisal) && $appraisal->review_type_id == $id) ? 'selected' : '' }}>{{ $review_type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div id="extended-div" style="display: none;">
                                <div class="form-group {{ $errors->has('extended_reason') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="extended_reason" name="extended_reason" class="form-control" value="{{ old('extended_reason', isset($appraisal) ? $appraisalextended_reason->extended_reason : '') }}">
