...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{ trans('cruds.article.title_singular') }} {{ trans('global.list') }}</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable-Article" class="table table-bordered table-striped table-hover datatable datatable-Article">
                                <thead>
                                    <tr>
                                        <th width="10">
