...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{ trans('cruds.tag.title_singular') }} {{ trans('global.list') }}</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable-Tags" class="table table-bordered table-striped table-hover datatable datatable-Tags">
                                <thead>
                                    <tr>
                                        <th width="10">
