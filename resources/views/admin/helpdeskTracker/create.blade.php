...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Create Helpdesk Call Entry</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header" style="color:white;background:#91c556;">
                        <h4>Helpdesk Call Tracker Form</h4>

                    </div>
                    <div class="card-body">
                        <form method="POST" style="min-height:300px;" id="sales-tracker-form" action="{{ route('admin.helpdesktracker.store') }}">
                            @csrf
                            ...
                            <div class="form-group row s1a">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" class="form-control" name="call_date" value="{{ date('Y-m-d') ?? '' }}">
                            ...
                            <div class="form-group row s1a">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group date" id="call-timepicker" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" name="call_time" data-target="#call-timepicker" value="{{ date('h:i:s') ?? '' }}">
                ...
                <div class="form-group row s1">
                    ...
                    <div class="col-md-4">
                        <input id="customer_name" type="text" value="" class="form-control" name="customer_name" required autocomplete="title" autofocus>
                    </div>
                    ...
                    <div class="col-md-4">
                        <input id="address" type="text" value="" class="form-control" name="address" required autocomplete="title" autofocus>
                    </div>
                </div>
                <hr>
                ...
                <div class="form-group row s1a">
                    ...
                    <div class="col-md-4">
                        <select class="form-control select2" name="escalation" data-width="100%" id="escalation">
                            <option value="">Select an Escalation</option>
